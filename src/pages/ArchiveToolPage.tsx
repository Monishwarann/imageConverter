    ...
    <div className="flex flex-col gap-6">
      <div className="glass-panel p-6 rounded-3xl border border-slate-800 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-white">Archive Tools & ZIP Suite</h2>
            <p className="text-xs text-slate-400">Create ZIP archives with subfolders or extract ZIP, TAR, GZ, 7Z safely in browser.</p>
          </div>
        </div>
        ...
        <div className="hidden sm:flex items-center gap-2 text-xs font-semibold text-emerald-400 bg-emerald-950/40 px-3 py-1.5 rounded-xl border border-emerald-800/40">
          ...
          <span>Zip Bomb & Traversal Guard</span>
        </div>
      </div>
